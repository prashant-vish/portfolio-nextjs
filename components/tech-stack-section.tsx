...
const techStack = [
  {
    name: "C++",
    icon: "/portfolio/tech/cpp.svg",
    category: "Languages",
  },
  {
    name: "Javascript",
    icon: "/portfolio/tech/javascript.svg",
    category: "Languages",
  },
  {
    name: "Typescript",
  ...
  {
    name: "Firebase",
    icon: "/portfolio/tech/firebase.svg",
    category: "BaaS",
  },
  {
    name: "PostgreSQL",
  ...
  {
    name: "Prisma",
    icon: "/portfolio/tech/prisma.svg",
    category: "ORM",
  },
  {
    name: "SQL",
    ...
    <section className="relative  py-32 overflow-hidden bg-gradient-to-b from-background to-background/50">
      ...
      <div id="techstack" className="container relative mx-auto px-4">
        <div className="flex flex-col items-center justify-center max-w-6xl mx-auto">
          ...
          >
            <span className="text-primary text-sm font-medium  mt-28 mb-2 block">
              My Tech Stack
            </span>
