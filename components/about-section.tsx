  ...
  const topRow = [
    {
      ...
      description:
        "Crafting responsive UIs with modern frameworks for intuitive user experiences.",
      icon: Code,
      color: "text-blue-500",
    },
    {
  ...
  const bottomRow = [
    {
      ...
      description:
        "Implementing cutting-edge AI solutions with LLMs, Computer Vision, and ML models",
      icon: Blocks,
      color: "text-pink-500",
    },
    {
