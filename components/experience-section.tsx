...
interface ProjectsSectionProps {
  ...
  subtitle?: string;
  className?: string;
  onProjectsReorder?: (newOrder: Experience[]) => void;
}
...
export function ExperienceSection({
  projects: initialProjects = defaultExperiences,
  title = "Experience",
  subtitle = "",
  className = "",
  onProjectsReorder,
  ...
  return (
    <section
      className={`relative py-32 overflow-hidden bg-gradient-to-b from-background to-background/50 ${className}`}
    >
      {/* Background Effects */}
      ...
      <div className="container relative mx-auto px-4">
        ...
        >
          ...
          >
            <motion.span
              className="text-primary text-sm font-medium mt-32 mb-3 block text-blue-500"
              initial={{ opacity: 0 }}
            ...
            <h3 className="text-gray-400 text-sm mb-2 transition-colors duration-500 group-hover:text-gray-300">
              Past Experiences Improves Efficiency and Flexibility
            </h3>
                    ...
                    <div className="absolute left-0 right-0 top-0 bottom-0 hidden lg:block pointer-events-none">
                      ...
                      >
                        <div className="relative">
                          <div
                            className={`absolute h-6 w-6 -left-3 -top-3 rounded-full blur-[10px] bg-gradient-to-r ${project.color}`}
                          />
                          <div
                            className={`h-5 w-5 rounded-full relative bg-gradient-to-r ${project.color}`}
                            style={{
                              boxShadow:
                                "0 0 20px var(--primary), 0 0 40px var(--primary-light)",
                            }}
                          />
                        </div>
                      </motion.div>
                        ...
                        <div className="absolute top-0 left-0 right-0 h-8 bg-[#2D2D2D] backdrop-blur-sm z-20 flex items-center px-3 gap-2 border-b border-white/10">
                          <div className="flex gap-1.5">
                            <div className="w-3 h-3 rounded-full bg-[#FF5F57] flex items-center justify-center">
                              <svg
                                className="w-2 h-2 text-[#450d0d] opacity-0 group-hover:opacity-100 transition-opacity"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
                            ...
                            <div className="w-3 h-3 rounded-full bg-[#FFBD2E] flex items-center justify-center">
                              <svg
                                className="w-2 h-2 text-[#5c4813] opacity-0 group-hover:opacity-100 transition-opacity"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
                            ...
                            <div className="w-3 h-3 rounded-full bg-[#28C840] flex items-center justify-center">
                              <svg
                                className="w-2 h-2 text-[#1b5c24] opacity-0 group-hover:opacity-100 transition-opacity"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
                                ...
                                <>
                                  ...
                                  >
                                    <path
                                      ...
                                      strokeLinejoin="round"
                                      strokeWidth={2}
                                      d="M12 2C6.477 2 2 6.477 2 12c0 5.524 4.477 10 10 10s10-4.476 10-10c0-5.523-4.477-10-10-10z"
                                    />
                                  </svg>
        ...
        <defs>
          {orderedProjects.map((project, index) => (
            ...
            >
              <stop
                offset="0%"
                stopColor={`hsl(${45 + index * 120}, 70%, 50%)`}
              />
              <stop
                offset="100%"
                stopColor={`hsl(${45 + index * 120}, 70%, 60%)`}
              />
            </linearGradient>
          ))}
        </defs>
